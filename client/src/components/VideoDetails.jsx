  ...
  return (
    <div className="flex flex-col  my-3">
      ...
      <div className="flex flex-col border border-gray-500  bg-gray-700 rounded-lg shadow mx-3 p-2 h-28 max-h-28">
        ...
        <span className="overflow-auto p-1 rounded-lg">I WAS THE ONE WHO GOT TRICKED I WAS THE ONE WHO GOT TRICKEDI WAS THE ONE WHO GOT TRICKED I WAS THE ONE WHO GOT TRICKEDI WAS THE ONE WHO GOT TRICKED I WAS THE ONE WHO GOT TRICKED</span>
      </div>
